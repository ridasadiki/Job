...
<section class="section-5">
    <div class="container my-5">
        ...
        <div class="alert alert-success">
            <p class="row d-flex justify-content-center">{{ Session::get('success') }}</p>
        </div>
        @endif

        @if(Session::has('error'))
        <div class="alert alert-danger">
            <p class="row d-flex justify-content-center">{{ Session::get('error') }}</p>
        </div>
        @endif
        <div class="row d-flex justify-content-center">
            <div class="col-md-5">
                <div class="card shadow border-0 p-5">
                    ...
                    <form action="{{ route('account.authentificate') }}" method="post">
                        @csrf
                        <div class="mb-3">
