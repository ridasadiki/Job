                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input value="{{ $job->title }}" type="text" placeholder="Job Title" id="title" name="title" class="form-control">                                <p></p>
                                </div>
                                <div class="col-md-6  mb-4">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="jobType" id="jobType" class="form-select">
                                        ...
                                        @if ($jobTypes->isNotEmpty())
                                            ...
                                            <option {{ ($job->job_type_id == $jobType->id) ? 'selected' : '' }} value="{{ $jobType->id }}">{{ $jobType->name }}</option>                                        @endforeach
                                        @endif
                                    </select>
                                    <p></p>
                                </div>
