...
class AccountController extends Controller
{
    ...
    public function authentificate(Request $request) {
        ...
        if ($validator->passes()) {
            ...
            return redirect()->route('account.login')->withErrors($validator)->withInput($request->all());
        }
    }
    ...
    public function updateProfilePic(Request $request){
        ...
        if($validator->passes()){
            ...
            //suprimer la dernier photo
            File::delete(public_path('/profile_pic/thumb/'.$imageName));
            File::delete(public_path('/profile_pic'.$imageName));
    ...
    public function editJob(Request $request, $id){
        ...
        $job = Job::where([
            ...
            'id' => $id
        ])->first(); // Add first() or get() to execute the query
